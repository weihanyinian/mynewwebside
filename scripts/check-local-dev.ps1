...
Write-Host "8080 = Spring Boot (mvn spring-boot:run) — required or browser gets 502" -ForegroundColor Yellow
...
Write-Host "  docker compose -f docker/docker-compose.ncm-only.yml up -d"
Write-Host ""
